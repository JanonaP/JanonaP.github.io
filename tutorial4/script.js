...
console.log(typeof guestInput.value);
...
btnYes.addEventListener('click', () => {
  ...
  guestField.classList.toggle('hidden');
    regret.classList.add('hidden');
  confirmation.classList.toggle('hidden');
   updateConfirmation();
  console.log('clicked rsvp confirm');
...
btnNo.addEventListener('click', () => {
  ...
  console.log('clicked rsvp regret');
...
nameInput.addEventListener('input', () => {
  ...
  if (isGoing) {
    ...
    regret.textContent = `I'm sad you're not coming, ${getName()}.`;
  }
});
