...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadButton.addEventListener('click', async function() {
        ...
        try {
            ...
            // YOUR CODE HERE:
            console.error('We had trouble loading the data:', error);
            statusDisplay.classList.remove('loading');
            statusDisplay.classList.add('error');
            statusMessage.textContent = 'We had trouble loading the data. Try again.';
    ...
    displayButton.addEventListener('click', function() {
        ...
        const placeholder = restaurantList.querySelector('.placeholder');
        if (placeholder) {
            placeholder.remove();
        }
    });
    ...
    mapButton.addEventListener('click', function() {
        ...
        const names = restaurants.map(function(restaurant) {
            return `<li class="name-list-item"><span class="restaurant-name">${restaurant.name}</span></li>`;
            }).join('');

            mappedList.innerHTML = `<ul class="name-list">${names}</ul>`;
    ...
    errorButton.addEventListener('click', async function() {
        ...
        try {
            ...
            <p class="status-message">Oops! We could not load data. Try again.</p>
            </div>`;
